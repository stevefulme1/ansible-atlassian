...
short_description: Retrieve information about version resources
version_added: "1.0.0"
description:
  - Retrieve a single version by its identifier, or list all version resources.
...
options:
  id:
    description:
      ...
      - When omitted, all version resources are listed.
    type: str
    required: false
...
RETURN = r"""
versions:
  description: List of version resources matching the query.
  returned: always
  type: list
  elements: dict
  contains:
...
def fetch_single(client, identifier):
    """Retrieve a single version by identifier."""
...
def main():
    ...
    try:
        ...
        if identifier is not None:
            ...
            result["versions"] = [item] if item else []
        else:
            result["versions"] = fetch_list(client, module)
