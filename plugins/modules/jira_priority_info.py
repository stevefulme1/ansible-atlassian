...
options:
  id:
    description:
      - The unique identifier of the jira priority to retrieve.
...
EXAMPLES = r"""
- name: Get a specific jira priority
...
RETURN = r"""
jira_prioritys:
  description: List of jira priority resources matching the query.
  returned: always
  type: list
  elements: dict
  contains:
...
def fetch_single(client, identifier):
    """Retrieve a single jira priority by identifier."""
...
def main():
    ...
    try:
        ...
        if identifier is not None:
            ...
            result["jira_prioritys"] = [item] if item else []
        else:
            result["jira_prioritys"] = fetch_list(client, module)
