"""Unit tests for stevefulme1.atlassian.confluence_space module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.atlassian.plugins.modules.confluence_space"
CLIENT_PATH = "ansible_collections.stevefulme1.atlassian.plugins.module_utils.api_client"


def _build_resource(**overrides):
    """Return a mock confluence_space resource dict."""
    base = {
        "id": "res-123",
        "name": "test-name",
        "alias": "test-alias",
...
def resource_args(module_args):
    """Module args for confluence_space operations."""
    module_args.update({
        "state": "present",
...
class TestGetCurrentState:
    ...
    def test_returns_none_without_lookup(self, resource_args):
        ...
        from ansible_collections.stevefulme1.atlassian.plugins.modules.confluence_space import get_current_state
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.atlassian.plugins.modules.confluence_space import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.atlassian.plugins.modules.confluence_space import build_payload
