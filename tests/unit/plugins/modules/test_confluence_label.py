"""Unit tests for stevefulme1.atlassian.confluence_label module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.atlassian.plugins.modules.confluence_label"
...
def resource_args(module_args):
    """Module args for confluence_label operations."""
    module_args.update({
        "state": "present",
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.atlassian.plugins.modules.confluence_label import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.atlassian.plugins.modules.confluence_label import build_payload
...
class TestCreate:
    ...
    def test_create_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        with patch(f"{MODULE_PATH}.get_current_state", return_value=None):
            from ansible_collections.stevefulme1.atlassian.plugins.modules.confluence_label import main
            main()
