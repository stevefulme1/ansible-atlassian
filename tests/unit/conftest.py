"""Shared fixtures for stevefulme1.atlassian unit tests."""
...
# ansible_collections.stevefulme1.atlassian resolves to the repo root.
...
_ns_path = os.path.join(_fake_root, 'ansible_collections', 'stevefulme1', 'atlassian')
